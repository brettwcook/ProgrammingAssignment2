...
##
##The cache matrix creation function creates a matrix
##  which is capable of storing a value and inverting
##  that value
##
## Objective #1
...
##The cacheSolve function collect the cached value
##  adn performs a computation 
##
## Objective #2
